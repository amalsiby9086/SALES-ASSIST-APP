...
<form action="#" id="login" class="login100-form2" style="float:left" method="post">
									<div class="billing-details jumbotron" style="height: 491px;">
                                    <div class="section-title">
                                        <h2 class="login100-form-title p-b-49" >Reset Password</h2>
                                    </div>
                                   
                                    
                                    <div class="form-group1">
                                    &nbsp&nbsp<label for="email">Password</label>
                                        <input class="input input-borders" type="password" name="pass1" placeholder="password" id="password" required style="border-radius: 40px">
                                    </div>
                                    
                                    <div class="form-group1">
                                    &nbsp&nbsp<label for="email">confirm Password</label>
                                        <input class="input input-borders" type="password" name="pass2" placeholder="password" id="password" required style="border-radius: 40px">
                                    </div>
                                    ...
                                    <div class="form-group1">
                                        <input class="primary-btn btn-block" name="reset_button"   type="submit"  Value="Reset Password"></div>
                                        <!--div class="panel-footer"><div class="alert alert-danger"><h4 id="e_msg"></h4></div></div-->
                                    <?php
		...
		exit();
                                        ...
                                        if ($pass1 != $pass2) {
                                           ...
                                           // $update_pwd = mysqli_query($con,"UPDATE admin_info set admin_password='$pass' where admin_email='$email'");
                                            mysqli_query($con, "UPDATE `user_info` SET `password`='$pass' WHERE `email`='$email'");
                
                                            mysqli_query($con, "DELETE FROM `password_reset_temp` WHERE `email` = '$email'");
                
                                            echo "<script type='text/javascript'>
                                            window.location.href = 'http://localhost/sales1/loginform.php?link=success'</script>";
                                        }
                                    }
                                    ?>
                               ...
                               if ( $count==3 ) {
                                ...
                                echo "<span style='color:red;'><center><b>All Field should required</b></center></span>'";
                                 }
                                  if ( $count==1) {

                                    echo "<span style='color:red;'><center><b>Invalid Link</b></center></span>'";
                                     }
                                     if ( $count==2) {

                                        echo "<span style='color:red;'><center><b>Link Expired</b></center></span>'";
                                         }
                                         if ( $count==4 ) {

                                            echo "<span style='color:red;'><center><b>Password Not Match</b></center></span>'";
                                             }
                                        ?>
