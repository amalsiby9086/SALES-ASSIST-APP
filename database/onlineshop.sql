...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 19, 2022 at 03:11 PM
...
CREATE TABLE `deliveryboy_info` (
  `deliboy_id` int(10) NOT NULL,
  `boy_first_name` varchar(100) NOT NULL,
  `boy_last_name` varchar(100) NOT NULL,
  `boy_email` varchar(300) NOT NULL,
  `boy_password` varchar(300) NOT NULL,
  `boy_mobile` varchar(10) NOT NULL,
  `boy_address1` varchar(300) NOT NULL,
  `boy_address2` varchar(11) NOT NULL,
  `boy_lisence` varchar(100) NOT NULL,
  `status` varchar(40) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `deliveryboy_info`
--

INSERT INTO `deliveryboy_info` (`deliboy_id`, `boy_first_name`, `boy_last_name`, `boy_email`, `boy_password`, `boy_mobile`, `boy_address1`, `boy_address2`, `boy_lisence`, `status`) VALUES
(3, 'AMAL ', 'ASHOK', 'amalashokunni345@gmail.com', '123456789', '9072988148', 'Budhanoor', 'kerala', 'D6101-40706-60905', 'assigned'),
(4, 'Arjun ', 'krishna', 'amal@gmail.com', '123456789', '9072988148', 'sree shylam', 'Budhanoor', 'D6101-40706-60905', 'notassigned'),
(5, 'AMAL ', 'ASHOK', 'amalkunni345@gmail.com', '123456789', '9072988148', 'Budhanoor', 'kerala', 'D6101-40706-60905', 'notassigned');
...
(1, 29, 'sreedevi ASHOK', 'sree@gmail.com', 'Budhanoor', 'Budhanoor', 'kerala', 689510, 'sreedevi Ashok', '1234567898765434', '12/22', 2, 45000, 123);
...
(82, 1, 2, 'steel bar', 12000, 'vsbbbbbbbbbb', '1641648601_Screenshot (1).png', 'wvwv'),
(83, 1, 1, 'airpod', 1200, 'qffff', '1641648715_Screenshot (2).png', 'wvwv'),
(84, 1, 1, 'airpod', 1200, 'sags', '1641648921_Screenshot (2).png', 'eeebe'),
(85, 1, 1, 'samsung note74', 48000, 'samsung new phone', '1641657794_product07.png', 'samsung'),
(86, 2, 2, 'jezns', 4800, 'good one', '1641702796_7475-ladies-casual-dresses-summer-two-colors-pleated.jpg', '5nnhi5nhi5n'),
(87, 8, 44, 'steel bar', 48000, 'vebebb', '1641715097_2012-Winter-Sweater-for-Men-for-better-outlook.jpg', 'g4g4g'),
(88, 6, 2, 'ebeb', 4800, 'beebeeeeee', '1641715139_a2.jpg', 'samsung'),
(89, 1, 3, '34g44444', 4800, '4gggggggggg', '1641716098_a2.jpg', 'brrrrrrr'),
(90, 1, 4, 'stel bar', 4800, '6mmm steel bar', '1641717723_41OJZebRUoL._SL246_SX190_CR0,0,190,246_.jpg', 'hvyhvyyyyyyyyyyyy'),
(91, 1, 1, 'stee bar', 4800, 'steel bar5mmm', '1641717921_asian-furniture-250x250.jpg', ' hd 222222222'),
(92, 2, 1, 'samsung note74', 4800, 'ubrdddgggg7rvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv', '1641718130_asian-furniture-250x250.jpg', 'eeebe'),
(93, 2, 2, 'steel bar', 4800, 'inivn33333', '1641718753_a2.jpg', 'venvnnine'),
(94, 3, 3, 'steel bar', 1200, 'vhyvvy', '1641898008_a2.jpg', 'eeebe');
...
CREATE TABLE `truck_info` (
  ...
  `truckbrand_name` varchar(100) NOT NULL,
...
INSERT INTO `truck_info` (`truck_id`, `truck_no`, `truckbrand_name`, `truck_capacity`) VALUES
(5, 'KL 09 AB 1234', 'Tata Motors', '150feet');

-- --------------------------------------------------------

--
-- Table structure for table `truvkdrier_info`
--

CREATE TABLE `truvkdrier_info` (
  `truckdriv_id` int(11) NOT NULL,
  `trucker_id` int(11) NOT NULL,
  `driver_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `truvkdrier_info`
--

INSERT INTO `truvkdrier_info` (`truckdriv_id`, `trucker_id`, `driver_id`) VALUES
(1, 5, 3);
...
(26, 'Amal', 'Ashok', 'amal@gmail.com', 'Amal@2621', '9446376932', 'kalavilathekkethil, Muttom PO Haripad', 'Muttom PO H'),
(27, 'Arjun', 'krishna', 'arjun@gmail.com', '123456789', '9961457890', 'sree shylam, Budhanoor', 'Budhanoor'),
(29, 'sreedevi', 'ASHOK', 'sree@gmail.com', '789456123', '9072988148', 'Budhanoor', 'Budhanoor');
...
(12, 'Jyothi ', 'R', 'jyothirevanna@gmail.com', 'impajyothi', '8762911138', 'Mugthihalli', 'Chikmaglur'),
(14, 'Kavya ', 'M E', 'kavyame046@gmail.com', 'kavyame', '8762435764', 'Mallenahalli,', 'Chikmaglur'),
(15, 'Hema ', 'H V', 'hemahv1713@gmail.com', 'hemahv', '9606429858', 'Rangoligundi', 'Hassan'),
(26, 'Amal', 'Ashok', 'amal@gmail.com', 'Amal@2621', '9446376932', 'kalavilathekkethil, Muttom PO Haripad', 'Muttom PO H'),
(27, 'Arjun', 'krishna', 'arjun@gmail.com', '123456789', '9961457890', 'sree shylam, Budhanoor', 'Budhanoor'),
(28, 'Roopesh', 'r', 'r@gmail.com', '123456789', '9446376932', 'kalavilathekkethil, Muttom PO Haripad', 'Muttom PO H'),
(29, 'sreedevi', 'ASHOK', 'sree@gmail.com', '789456123', '9072988148', 'Budhanoor', 'Budhanoor');
...
--
-- Indexes for table `truvkdrier_info`
--
ALTER TABLE `truvkdrier_info`
  ADD PRIMARY KEY (`truckdriv_id`),
...
--
ALTER TABLE `deliveryboy_info`
  MODIFY `deliboy_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `products`
  MODIFY `product_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;

--
-- AUTO_INCREMENT for table `truck_info`
--
ALTER TABLE `truck_info`
  MODIFY `truck_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `truvkdrier_info`
--
ALTER TABLE `truvkdrier_info`
  MODIFY `truckdriv_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Constraints for table `truvkdrier_info`
--
ALTER TABLE `truvkdrier_info`
  ADD CONSTRAINT `truvkdrier_info_ibfk_1` FOREIGN KEY (`trucker_id`) REFERENCES `truck_info` (`truck_id`),
  ADD CONSTRAINT `truvkdrier_info_ibfk_2` FOREIGN KEY (`driver_id`) REFERENCES `deliveryboy_info` (`deliboy_id`),
  ADD CONSTRAINT `truvkdrier_info_ibfk_3` FOREIGN KEY (`driver_id`) REFERENCES `deliveryboy_info` (`deliboy_id`);
COMMIT;
