...
<form action="login1.php" id="login" class="login100-form2" style="float:left" method="post">
									<div class="billing-details jumbotron" style="height: 500px;">
                                    <div class="section-title">
                                        <h2 class="login100-form-title p-b-49" >Login Here</h2>
                                    </div>
  ...
  togglePassword.addEventListener('click', function (e) {
    ...
    this.classList.toggle('fa-eye-slash');
                                    ...
                                    <div class="form-group1" >
                                    &nbsp&nbsp<a href="index.php" class="fa fa-arrow-left">
                                           Back to Home
                                       </a>
                                       <a href="forgotpassword.php" class="text-pad" style="padding-left: 53%;">
                                           forget password ?
                                       </a>
                                        
                                    </div>
                                    <div class="form-group1">
                                        <input class="primary-btn btn-block" name="login_button"   type="submit"  Value="Login"></div>
                                        <!--div class="panel-footer"><div class="alert alert-danger"><h4 id="e_msg"></h4></div></div-->
                               ...
                               $fullurl = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
                                  if ( strpos( $fullurl, "login=failure" )==true ) {
                                    ...
                                    echo "<span style='color:red;'><center><b>Please register before login..!</b></center></span>'";
                                     }
                                     if ( strpos( $fullurl, "link=success" )==true ) {

                                        echo "<span style='color:green;'><center><b>Congratulations! Your password has been updated successfully.</b></center></span>'";
                                         }
                                         if ( strpos( $fullurl, "signup=success" )==true ) {

                                            echo "<span style='color:green;'><center><b>Congratulations! Registration is successfully done.</b></center></span>'";
                                             }
                                        ?>
