					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="header-search">
								<form>
									<!--select class="input-select">All Categories
										<option value="0">All Categories</optio>
										<option value="1">Men</option>
										<option value="1">Women </option>
									</select-->
									<input class="input" id="search" type="text" style="border-radius: 40px 0px 0px 40px" placeholder="Search here">
