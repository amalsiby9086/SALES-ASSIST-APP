...
if(isset($_POST['btn_save'])) {
	...
	if($count_email > 0){
		...
		mysqli_query($con,"INSERT INTO `deliveryboy_info`(`boy_first_name`, `boy_last_name`, `boy_email`, `boy_password`, `boy_mobile`, `boy_address1`, `boy_address2`, `boy_lisence`) VALUES ('$f_name ','$l_name','$email','$password','$mobile','$address1','$address2','$lis')") 
